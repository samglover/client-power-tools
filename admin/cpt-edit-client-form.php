...
<form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST" autocapitalize="none" autocorrect="off" autocomplete="off">
  ...
  <div class="cpt-row">
    <div class="form-field">
      ...
      <input name="client_id" id="client_id" class="regular-text" type="text" value="<?php echo $client_data['client_id']; ?>">
    </div>
      <div class="form-field span-3">
        <label for="client_name"><?php _e('Client Name', 'client-power-tools'); ?></label>
        <input name="client_name" id="client_name" class="regular-text" type="text" value="<?php echo $client_data['client_name']; ?>">
      </div>
  </div>
  <div class="cpt-row">
  ...
  <div class="cpt-row">
    <div class="form-field span-3">
      ...
      <input name="email" id="email" class="regular-text" type="text" data-required="true" value="<?php echo $client_data['email']; ?>">
    </div>
  </div>
  <div class="cpt-row">
  ...
  <div class="cpt-row">
    <div class="form-field span-3">
      ...
      <textarea name="email_ccs" id="email_ccs" class="regular-text" rows="3" type="text"><?php echo $client_data['email_ccs']; ?></textarea>
  ...
  <?php } ?>
  <p class="submit">
    <input name="submit" id="submit" class="button button-primary wp-element-button" type="submit" value="<?php _e('Update Client', 'client-power-tools'); ?>">
  </p>
</form>
