  ...
  <table class="form-table" role="presentation">
    <tbody>
          ...
          <?php if ($client_ids) { ?>
            <select name="client_id" id="client_id" required>
              <?php foreach ($client_ids as $client_id) { ?>
                <option value="<?php echo $client_id; ?>"<?php selected(get_post_meta($project_id, 'cpt_client_id', true), $client_id); ?>><?php echo Common\cpt_get_name($client_id); ?></option>
              <?php } ?>
            </select>
          <?php } ?>
        </td>
      ...
      <tr>
        ...
        <td>
          <input name="project_name" id="project_name" class="regular-text" type="text" required aria-required="true"></input>
        </td>
      </tr>
      <tr>
        <th scope="row">
